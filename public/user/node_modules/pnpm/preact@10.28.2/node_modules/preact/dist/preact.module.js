var n, l, u, t, i, o, r, e, f, c, s, a, h, p = {},
    v = [],
...
function P(n, l, u, t, i) {
    ...
    if (a)
        for (o = 0; o < s; o++) null != (e = u[o]) && 0 == (2 & e.__u) && (e.__e == t && (t = S(e)), D(e, e));
    return t
}
...
function L(n, l, u, t) {
    ...
    if (t > (s ? 1 : 0))
        for (i = u - 1, o = u + 1; i >= 0 || o < l.length;)
            if (null != (c = l[r = i >= 0 ? i-- : o++]) && 0 == (2 & c.__u) && e == c.key && f == c.type) return r;
    return -1
}
...
function O(n, u, t, i, o, r, e, f, c, s) {
    ...
    128 & t.__u && (c = !!(32 & t.__u), r = [f = u.__e = t.__e]), (a = l.__b) && a(u);
    n: if ("function" == typeof j) try {
        ...
        h.state = h.__s, null != h.getChildContext && (i = w(w({}, i), h.getChildContext())), S && !p && null != h.getSnapshotBeforeUpdate && (_ = h.getSnapshotBeforeUpdate(v, y)), L = a, null != a && a.type === k && null == a.key && (L = V(a.props.children)), f = I(n, d(L) ? L : [L], u, t, i, o, r, e, f, c, s), h.base = u.__e, u.__u &= -161, h.__h.length && e.push(h), m && (h.__E = h.__ = null)
    } catch (n) {
...
function q(u, t, i, o, r, e, f, c, s) {
    ...
    if (null == x) b === k || c && u.data == k || (u.data = k);
        ...
        if (e = e && n.call(u.childNodes), !c && null != e)
            for (b = {}, a = 0; a < u.attributes.length; a++) b[(w = u.attributes[a]).name] = w.value;
        for (a in b)
            if (w = b[a], "children" == a);
        ...
        else if (v && (u.innerHTML = ""), I("template" == t.type ? u.content : u, d(y) ? y : [y], t, i, o, "foreignObject" == x ? "http://www.w3.org/1999/xhtml" : r, e, f, e ? e[0] : i.__k && S(i, 0), c, s), null != e)
...
function D(n, u, t) {
    ...
    if (i = n.__k)
        for (o = 0; o < i.length; o++) i[o] && D(i[o], u, t || "function" != typeof n.type);
...
function G(u, t, i) {
    var o, r, e, f;
    t == document && (t = document.documentElement), l.__ && l.__(u, t), r = (o = "function" == typeof i) ? null : i && i.__k || t.__k, e = [], f = [], O(t, u = (!o && i || t).__k = _(k, null, [u]), r || p, p, t.namespaceURI, !o && i ? [i] : r ? null : t.firstChild ? n.call(t.childNodes) : null, e, !o && i ? i : r ? r.__e : t.firstChild, o, f), N(e, u, f)
}
...
export {
    x as Component, k as Fragment, K as cloneElement, Q as createContext, _ as createElement, b as createRef, _ as h, J as hydrate, t as isValidElement, l as options, G as render, H as toChildArray
};
